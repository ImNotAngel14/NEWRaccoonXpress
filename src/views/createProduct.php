...
<body class="container d-flex justify-content-center ">
                    ...
                    <form method="POST" class="needs-validation" novalidate>
                        ...
                        <div class="mb-3">
                            <select class="form-select" name="user_role" required>
                                ...
                                <option value="2" class="opcion">Comprador</option>
                                <option value="1" class="opcion">Vendedor</option>
                            </select>
                            <div class="invalid-feedback">Seleccione el tipo de cuenta.</div>
                        </div>
                        <div class="text-center mb-3">
                            <button type="submit" class="btn w-100 my-primary">Registrarse</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script src="/NewRaccoonXpress/src/views/js/register.js"></script>
</body>
